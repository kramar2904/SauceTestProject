...
def setUp() {
	println("From SauceTestSuite- Setup")
}
...
def tearDown() {
		println("From SauceTestSuite- TearDown")
}
...
def setupTestCase() {
		println("From SauceTestSuite- SetupTestCase")
}
...
def tearDownTestCase() {
		println("From SauceTestSuite- TearDownTestCase")
}
